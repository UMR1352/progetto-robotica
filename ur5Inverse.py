...
def ur5Inverse(p60, R60):
    T60 = np.concatenate((np.concatenate((R60, p60), axis=1), [0, 0, 0, 1]), axis=0)

    # Finding th1
    p50 = T60 * np.array([0, 0, -D[5], 1]).transpose()
    th1_1 = arctan2(p50[1], p50[0]) + arccos(D[3]/hypot(p50[1], p50[0])) + pi / 2
    th1_2 = arctan2(p50[1], p50[0]) - arccos(D[3]/hypot(p50[1], p50[0])) + pi / 2
    ...
    th6_1 = arctan2((-Xhat[1] * sin(th1_1) + Yhat[1] * cos(th1_1)) / sin(th5_1), (Xhat[0] * sin(th1_1) - Yhat[0] * cos(th1_1)) / sin(th5_1))
    th6_2 = arctan2((-Xhat[1] * sin(th1_1) + Yhat[1] * cos(th1_1)) / sin(th5_2), (Xhat[0] * sin(th1_1) - Yhat[0] * cos(th1_1)) / sin(th5_2))
    th6_3 = arctan2((-Xhat[1] * sin(th1_1) + Yhat[1] * cos(th1_2)) / sin(th5_3), (Xhat[0] * sin(th1_2) - Yhat[0] * cos(th1_2)) / sin(th5_3))
    th6_4 = arctan2((-Xhat[1] * sin(th1_1) + Yhat[1] * cos(th1_2)) / sin(th5_4), (Xhat[0] * sin(th1_2) - Yhat[0] * cos(th1_2)) / sin(th5_4))
    ...
    # Same shit for th2
    th2_1 = arctan2(-p41_1[2], -p41_1[0]) - arcsin((-A[2] * sin(th3_1)) / p41xz_1)
    th2_2 = arctan2(-p41_2[2], -p41_2[0]) - arcsin((-A[2] * sin(th3_2)) / p41xz_2)
    th2_3 = arctan2(-p41_3[2], -p41_3[0]) - arcsin((-A[2] * sin(th3_3)) / p41xz_3)
    th2_4 = arctan2(-p41_4[2], -p41_4[0]) - arcsin((-A[2] * sin(th3_4)) / p41xz_4)
    th2_5 = arctan2(-p41_1[2], -p41_1[0]) - arcsin((A[2] * sin(th3_1)) / p41xz_1)
    th2_6 = arctan2(-p41_2[2], -p41_2[0]) - arcsin((A[2] * sin(th3_2)) / p41xz_2)
    th2_7 = arctan2(-p41_3[2], -p41_3[0]) - arcsin((A[2] * sin(th3_3)) / p41xz_3)
    th2_8 = arctan2(-p41_4[2], -p41_4[0]) - arcsin((A[2] * sin(th3_4)) / p41xz_4)
